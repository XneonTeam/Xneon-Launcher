      ...
      <div className="flex items-center gap-2">
        <div className="flex gap-1 p-1 rounded-lg bg-muted/40">
          <button key="my" type="button" onClick={() => setView("my")}
            ...
            <IconStack2 className="w-4 h-4" strokeWidth={1.75} />
            {t("builds.myBuilds")}
          </button>
          <button key="modrinth" type="button" onClick={() => setView("modrinth")}
            className={cn("flex items-center gap-1.5 px-4 py-1.5 rounded-md text-sm font-medium transition-all",
              view === "modrinth" ? "bg-green-500 text-white" : "text-muted-foreground hover:text-foreground")}>
          ...
          <button key="curseforge" type="button" onClick={() => setView("curseforge")}
            className={cn("flex items-center gap-1.5 px-4 py-1.5 rounded-md text-sm font-medium transition-all",
              view === "curseforge" ? "bg-orange-500 text-white" : "text-muted-foreground hover:text-foreground")}>
            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
