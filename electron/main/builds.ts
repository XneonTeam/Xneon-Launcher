...
// eslint-disable-next-line @typescript-eslint/no-require-imports
const toml = require("toml") as { parse(input: string): Record<string, unknown> }
...
function parseManifestMf(zip: InstanceType<typeof AdmZip>): { version?: string } | null {
...
function parseMcmodInfo(zip: InstanceType<typeof AdmZip>): ModMetadata | null {
...
function parseLiteModJson(zip: InstanceType<typeof AdmZip>): ModMetadata | null {
...
function parseFabricModJson(zip: InstanceType<typeof AdmZip>): ModMetadata | null {
...
function parseQuiltModJson(zip: InstanceType<typeof AdmZip>): ModMetadata | null {
...
function parseModsToml(zip: InstanceType<typeof AdmZip>, tomlPath: string): ModMetadata | null {
...
function parseNeoForgeModsToml(zip: InstanceType<typeof AdmZip>): ModMetadata | null {
  return parseModsToml(zip, "META-INF/neoforge.mods.toml")
}

function parseForgeModsToml(zip: InstanceType<typeof AdmZip>): ModMetadata | null {
  return parseModsToml(zip, "META-INF/mods.toml")
}

function readModMetadataFromArchive(filePath: string): ModMetadata {
  try {
